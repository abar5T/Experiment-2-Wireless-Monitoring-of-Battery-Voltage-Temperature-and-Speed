...
## Output:
![WhatsApp Image 2025-09-30 at 10 41 07_1972e8a6](https://github.com/user-attachments/assets/6bcceef4-03fa-4855-9a59-6b3a790f1b08)



 
## Result:
Thus,the MATLAB program successfully receives and visualizes real-time battery voltage, temperature, and speed data from the embedded system using wireless communication.
